...
class JModuleOp extends JBinaryExpression {

    /**
     * Construct an AST for a modulo expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the modulo expression occurs in the
     *            source file.
     * @param lhs
     *            the lhs operand.
     * @param rhs
    ...
    public JModuleOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "%", lhs, rhs);
    }
