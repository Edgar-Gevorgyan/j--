...
class JPositiveOp extends JUnaryExpression {
    ...
    /**
     * Construct an AST node for a positive expression given its line number,
     * and the operand.
     * 
     * @param line
     *            line in which the positive expression occurs in the source
     *            file.
     * @param arg
     *            the operand.
     */
    ...
    /**
     * Analyzing the positive operation involves analyzing its operand, checking
     * its type and determining the result type.
     * 
     * @param context
     *            context in which names are resolved.
